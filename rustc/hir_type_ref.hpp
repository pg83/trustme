...
namespace HIR {
    ...
    class ResolvePlaceholdersNop: public ResolvePlaceholders {
        const ::HIR::TypeRef& get_type(const Span& sp, const HIR::TypeRef& ty) const {
            return ty;
        }

        const ::HIR::ConstGeneric& get_val(const Span& sp, const HIR::ConstGeneric& v) const {
            return v;
        }
    };
    ...
    public:
        class PopOnDrop {
            ...
            PopOnDrop(std::vector<const HIR::GenericParams*>& v)
                : v(&v)
            {
            }
    ...
    public:
        ...
        virtual ::HIR::Compare match_lft(const ::HIR::GenericRef& g, const ::HIR::LifetimeRef& sz) {
    ...
    public:
        ...
        static TypeRef new_tuple(::std::vector<::HIR::TypeRef> sts) {
            return TypeRef(mv$(sts));
        }
