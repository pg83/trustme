...
namespace {
    struct StmtRef {
        ...
        StmtRef(unsigned b, unsigned s)
            : bb_idx(b)
            , stmt_idx(s)
        {
        }

        bool operator==(const StmtRef& x) const {
    ...
    IterPathRes iter_path(const ::MIR::Function& fcn, const StmtRef& start, const StmtRef& end, ::std::function<bool(StmtRef, const ::MIR::Statement&)> cb_stmt, ::std::function<bool(StmtRef, const ::MIR::Terminator&)> cb_term) {
