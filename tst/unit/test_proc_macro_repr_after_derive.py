#!/usr/bin/env python3
"""Build and run the repr-after-derive check of a procedural macro against shared libstd."""
...
def main() -> int:
    ...
    with lib.workdir() as work:
        ...
        lib.run([os.path.join(out, "release", "proc_macro_repr_after_derive_unit")],
                env=env, timeout=60)
