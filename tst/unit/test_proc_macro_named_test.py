#!/usr/bin/env python3
"""Build and run the binary using a procedural-macro attribute named like a builtin against shared libstd."""
...
def main() -> int:
    ...
    with lib.workdir() as work:
        ...
        lib.run([os.path.join(out, "release", "proc_macro_named_test_unit")],
                env=env, timeout=60)
