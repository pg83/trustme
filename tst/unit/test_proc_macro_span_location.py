#!/usr/bin/env python3
"""Build and run a crate whose procedural macro reads the location of a span: start, end, line, column and file."""
...
def main() -> int:
    ...
    with lib.workdir() as work:
        ...
        lib.run([os.path.join(out, "release", "proc_macro_span_location_unit")],
                env=env, timeout=60)
