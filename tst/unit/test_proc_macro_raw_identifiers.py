#!/usr/bin/env python3
"""Build and run a crate whose procedural macro is handed raw identifiers of the item it annotates."""
...
def main() -> int:
    ...
    with lib.workdir() as work:
        ...
        lib.run([os.path.join(out, "release", "proc_macro_raw_identifiers_unit")],
                env=env, timeout=60)
