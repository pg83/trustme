#!/usr/bin/env python3
"""Build and run a crate whose procedural macro moves the caller's tokens into code of its own."""
...
def main() -> int:
    ...
    with lib.workdir() as work:
        ...
        lib.run([os.path.join(out, "release", "proc_macro_call_site_locals_unit")],
                env=env, timeout=60)
