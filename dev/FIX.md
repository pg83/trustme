...
| still failing on the current tree | 485 |
| fixed, or no longer reproducing, since the gate | 146 |

| priority class | tests |
|---|---:|
| accepted Rust rejected by the compiler or driver | 220 |
...
All 220 tests are positive programs accepted by Rust 1.90. A normal trustme
