...
1. Trait lookup, normalization, and inference: 8 inferred trait obligations
   left ambiguous and 3 const-value relation failures. Total adjacent impact:
   11 tests.
...
The 358 unfinished ordinary compiler rejections and one pathless-`--extern`
...
| type checking, HIR lowering, and resolution | 152 | result relation 20 |
