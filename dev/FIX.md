...
1. Trait lookup, normalization, and inference: 8 inferred trait obligations
   left ambiguous and 5 const-value relation failures. Total adjacent impact:
   13 tests.
...
The 360 unfinished ordinary compiler rejections and one pathless-`--extern`
...
| type checking, HIR lowering, and resolution | 154 | result relation 20 |
