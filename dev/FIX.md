...
1. Trait lookup, normalization, and inference: 8 inferred trait obligations
   left ambiguous and 4 const-value relation failures. Total adjacent impact:
   12 tests.
...
The 359 unfinished ordinary compiler rejections and one pathless-`--extern`
...
| type checking, HIR lowering, and resolution | 153 | result relation 20 |
