...
| still failing on the current tree | 461 |
| fixed, or no longer reproducing, since the gate | 170 |

| priority class | tests |
|---|---:|
| accepted Rust rejected by the compiler or driver | 207 |
...
All 207 tests are positive programs accepted by Rust 1.90. A normal trustme
...
| macro and attribute expansion | 10 | AST expansion 3; macro parsing/formatting 3; attributes 4 |
