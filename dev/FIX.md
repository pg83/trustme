...
After the targeted const-generic, CTFE, and TAIT reruns, 173 of the snapshot's internal compiler failures
...
| four signatures with four failures each | 16 | `trans_codegen_c`, `synext_macro`, bad-char parsing |
