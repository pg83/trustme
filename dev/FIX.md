...
pointer-mask, and volatile-memory reruns, 152 of the snapshot's internal
compiler failures remain. The former generic `mir_helpers.h:108` cluster is
subdivided below by its actual MIR error.
