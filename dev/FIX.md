...
There are 107 unfinished compiler-internal failures in 84 stable signatures.

| signature or root cause | tests | note |
|---|---:|---|
| 84 stable signatures | 107 | one to three tests each |
...
Four uncaught exceptions and five explicit MIR TODOs are included in the 107.
