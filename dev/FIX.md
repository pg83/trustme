...
1. Macro and attribute expansion: 7 unresolved macro invocations and 13
   unsupported derive applications. The largest remaining concrete macro family
   is `concat_bytes` (3); the derive failures contain 10
...
The 435 unfinished ordinary compiler rejections and one pathless-`--extern`
...
| macro and attribute expansion | 52 | unknown macro 7, missing derive 13 |
