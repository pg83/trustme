...
1. Trait lookup, normalization, and inference: 8 inferred trait obligations
   left ambiguous and 2 const-value relation failures. Total adjacent impact:
   10 tests.
...
The 357 unfinished ordinary compiler rejections and one pathless-`--extern`
...
| type checking, HIR lowering, and resolution | 151 | result relation 20 |
