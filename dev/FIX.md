...
`traits/alias/bounds`. Thus 85 of the 98 sweep failures
...
| still failing or still carried from the last full sweep | 110 |
| fixed, or no longer reproducing, since the gate | 521 |
...
subsequent point fixes have closed thirteen nodes, leaving 85. The remaining 25 are
...
|---|---:|---|
| type checking, HIR lowering, and resolution | 46 | trait/impl selection and type mismatch dominate |
