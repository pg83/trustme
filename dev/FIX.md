...
| still failing on the current tree | 480 |
| fixed, or no longer reproducing, since the gate | 151 |

| priority class | tests |
|---|---:|
| accepted Rust rejected by the compiler or driver | 215 |
...
All 215 tests are positive programs accepted by Rust 1.90. A normal trustme
