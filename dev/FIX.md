...
1. Repeated parser feature families: 7 ergonomic-clone `use` forms. The three
   remaining `TOK_DOUBLE_DOT` failures are range/expression syntax.
...
The 521 unfinished ordinary compiler rejections and one pathless-`--extern`
driver rejection split as follows:

| area | tests | largest stable groups |
|---|---:|---|
| parser | 180 | 89 at `parse_parseerror.cpp:63`, 69 at line 56, 19 at line 68, 3 in `parse_common.cpp` |
