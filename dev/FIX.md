...
1. Trait lookup, normalization, and inference: 10 inferred trait obligations
...
The 366 unfinished ordinary compiler rejections and one pathless-`--extern`
...
| type checking, HIR lowering, and resolution | 160 | result relation 20 |
