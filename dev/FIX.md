...
| still failing on the current tree | 522 |
| fixed, or no longer reproducing, since the gate | 109 |

| priority class | tests |
|---|---:|
| accepted Rust rejected by the compiler or driver | 259 |
...
All 259 tests are positive programs accepted by Rust 1.90. A normal trustme
