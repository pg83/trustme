...
After the targeted const-generic, CTFE, and TAIT reruns, 177 of the snapshot's internal compiler failures
...
| five signatures with four failures each | 20 | `trans_codegen_c`, `synext_macro`, MIR, bad-char parsing |
