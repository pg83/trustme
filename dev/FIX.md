...
There are 85 unfinished compiler-internal failures in 78 stable signatures.

| signature or root cause | tests | note |
|---|---:|---|
| 78 stable signatures | 85 | one to three tests each |
...
Four uncaught exceptions and five explicit MIR TODOs are included in the 85.
