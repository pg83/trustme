...
There are 81 unfinished compiler-internal failures in 77 stable signatures.

| signature or root cause | tests | note |
|---|---:|---|
| 77 stable signatures | 81 | one to three tests each |
...
Four uncaught exceptions and five explicit MIR TODOs are included in the 81.
