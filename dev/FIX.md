...
There are 110 unfinished compiler-internal failures in 85 stable signatures.

| signature or root cause | tests | note |
|---|---:|---|
| 85 stable signatures | 110 | one to three tests each |
...
Four uncaught exceptions and five explicit MIR TODOs are included in the 110.
