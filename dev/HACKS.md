...
- 128 строк с `hack/HACK/hacky/hackery/hackiness` в 31 файле.
- 96 точных употреблений слова `HACK`.
- 122 комментария и 6 диагностических `DEBUG`-строк.
- По подсистемам: frontend — 42, HIR/typeck — 54, MIR — 13, backend — 17, инфраструктура — 2.
