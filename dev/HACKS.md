...
- 126 строк с `hack/HACK/hacky/hackery/hackiness` в 30 файлах.
- 94 точных употреблений слова `HACK`.
- 120 комментариев и 6 диагностических `DEBUG`-строк.
- По подсистемам: frontend — 42, HIR/typeck — 53, MIR — 12, backend — 17, инфраструктура — 2.
...
| MIR passes | `mir_operations.cpp:2804,3937,4005,4031,4742` | Target-width constants, complete-type include, conservative intrinsic-wrapper inlining, drop-flag compaction и удаление drop заведомо неинициализированного local документированы как invariants. Остались Box layout coupling и usage downgrade. |
