...
- 127 строк с `hack/HACK/hacky/hackery/hackiness` в 30 файлах.
- 95 точных употреблений слова `HACK`.
- 121 комментарий и 6 диагностических `DEBUG`-строк.
- По подсистемам: frontend — 42, HIR/typeck — 54, MIR — 12, backend — 17, инфраструктура — 2.
