...
Следующий функциональный пункт — `T: Pointee<Metadata = ()>` в `ptr/const_ptr.rs:1657` полного `core -Znext-solver`, затем удаление глобальной fuzzy relation/impl matching, строго unit-first. Macro hygiene остаётся отдельной архитектурной задачей.
