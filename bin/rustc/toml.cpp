    ...
    switch (t.m_type) {
        ...
        case TomlToken::Type::SquareOpen: {
            ...
            if (skipped_nested) {
                ...
                ::std::cerr << "warning: " << m_lexer << ": skipped nested array / inline-table element(s) in `" << key << "` (not represented in the flat TOML value model)" << ::std::endl;
            }
            break;
        }
        case TomlToken::Type::BraceOpen:
