...
template <>
void stl::output<ZeroCopyOutput, std::pair<HIRPattern, const HIRType*>>(ZeroCopyOutput& out, const std::pair<HIRPattern, const HIRType*>& value) {
    out << StringView("(") << value.first << StringView(", ") << value.second << StringView(")");
}

template <>
void stl::output<ZeroCopyOutput, std::vector<std::pair<HIRPattern, const HIRType*>>>(ZeroCopyOutput& out, const std::vector<std::pair<HIRPattern, const HIRType*>>& values) {
    outCont(out, values);
}
