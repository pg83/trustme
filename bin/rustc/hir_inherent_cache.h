...
namespace HIR {
    ...
    private:
        ...
        struct Inner {
            ...
            void find(const Span& sp, const HIR::TypeData* curTy, tCbResolveType tyRes, innerCallbackT& cb) const;
        };
    ...
    public:
        ...
        void find(const Span& sp, const RcString& name, const HIR::TypeData* ty, tCbResolveType tyRes, callbackT cb) const;
    };
