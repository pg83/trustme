...
HIRPath::HIRPath(const HIRType* ty, RcString item, HIRPathParams itemParams)
    : data(Data::make_UfcsInherent({mv$(ty), mv$(item), mv$(itemParams)}))
{
}

HIRPath::HIRPath(const HIRType* ty, HIRGenericPath trait, RcString item, HIRPathParams itemParams)
